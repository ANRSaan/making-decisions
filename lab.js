...
{
  console.log("Being naked is probably fine")
}
else if (temperature > 60 && temperature < 80 && rain === false)
{
  console.log("Clothing recommended")
}
...
//should currently be set to false due to the if-else statement in Problem 9). 
...
//log a countdown from the value of z to 1. Once you have logged the countdown, make sure you 
